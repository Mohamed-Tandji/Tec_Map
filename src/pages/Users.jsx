...
import { AjouterFriend } from '../controllers/Friends';
            ...
            <tbody>
              {users.map((user) => (
                ...
                <tr>
                  ...
                  <td>
                    <a type="button" onClick={() => handleAdd(user._id)}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
